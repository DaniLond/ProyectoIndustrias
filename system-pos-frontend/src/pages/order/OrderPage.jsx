...
function OrderPage() {
    const { orders, getOrders, getProductToOrder, errors, getOrder } = useOrder();
    ...
    const [selectedOrderProductsForPrint, setSelectedOrderProductsForPrint] = useState([]);
    ...
    const handlePrintOrder = async (orderId) => {
        try {
            ...
            const orderProducts = await getProductToOrder(orderId);
            
            setSelectedOrderForPrint(orderInfo);
            setSelectedOrderProductsForPrint(orderProducts);
                    ...
                    <div className='relative flex justify-center items-center'>
                        <Dropdown className='bg-background border-1 border-default-200'>
                            ...
                            <DropdownMenu color='primary' variant='bordered'>
                                ...
                                <DropdownItem startContent={<FaPrint />} onPress={() => handlePrintOrder(order.id)}>
                                    Imprimir
                                </DropdownItem>
                            </DropdownMenu>
                        </Dropdown>
    ...
    return (
        <DefaultLayout>
            ...
            <PrintOrderModal
                ...
                orderProducts={selectedOrderProductsForPrint}
            />
        </DefaultLayout>
    );
}
